<?php
    ...
    include 'connect.php';
        ...
        $sql = "SELECT i.id, i.receipt_no, i.hall_no, i.stand_number, i.no_of_badges, i.total_amount, i.transaction_type, i.transaction_ref_no, 
                ...
                WHERE i.status='Issued' and i.cancelled = 0 order by i.id desc";
                ...
                <aside class="app-navbar">
                    ...
                    <div class="sidebar-nav scrollbar scroll_light">
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active"><a href="re-print.php" aria-expanded="false"><i class="nav-icon ti ti-hand-open"></i><span class="nav-title">Re-print Receipt</span></a> </li>
                                                    ...
                                                    <?php
                                                        if ($result->num_rows > 0) {
                                                            while ($row = $result->fetch_assoc()) {
                                                                ...
                                                                echo "<tr>";
                                                                echo "<td>
                                                                    <a href='http://www.imtex.in/exhibitor-badges/display_receipt.php?id=" . $row['id'] . "' target='_blank'>
                                                                        <button class='btn btn-sm btn-primary reprint-receipt' data-id='" . $row['id'] . "'>
                                                                            <span class='dripicons dripicons-print'></span>
                                                                        </button>
                                                                    </a>
                                                                </td>";
